...
${Update_Project_Success_Message} =     xpath=//div[@class='alert alert-success'][contains(text(),'updated successfully')]

*** Keywords ***

Update Project Name
    [Arguments]  ${Project_Name}
    wait until page contains element  ${update_project_form_project_name} 2s
...
Verify Project Updated Success message is displayed
     sleep  2s
    element should be visible  ${update_project_success_message}
